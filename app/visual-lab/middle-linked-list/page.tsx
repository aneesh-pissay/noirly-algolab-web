...
import { middleLinkedList } from '@/src/core/algorithms/two-pointers/middleLinkedList';
import { AlgorithmStep, VisualizerState } from '@/src/core/engine/types';

export default function MiddleLinkedListPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.registerAlgorithm('middle-linked-list', middleLinkedList);
    visualizerEngine.execute('middle-linked-list', {
      nodes: [
        { value: 1, next: 1 },
        { value: 2, next: 2 },
        { value: 3, next: 3 },
  ...
  const middleIndex = currentStep.visualizationData?.middleIndex ?? -1;
                ...
                {nodes.map((node: any, index: number) => {
                  ...
                  return (
                    <div key={index} className="flex items-center gap-6">
                      ...
                      {node.next !== null && (
                        <span className="material-symbols-outlined text-on-surface-variant text-3xl opacity-40">
                          arrow_forward
                        </span>
                      )}
                    </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    ...
                    <span className="font-code-md text-tertiary">
                      {variables.middleValue ?? 'not found'}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-tertiary">findMiddle</span>(head) &#123;
                    </div>
                    {/* Line 2 */}
                    ...
                    <div className={currentStep.codeLine === 10 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;<span className="text-primary-container">return</span> slow;
                    </div>
                    {/* Line 11 */}
                    <div>
                      &#125;
