...
import { fixedSizeWindow } from '@/src/core/algorithms/sliding-window/fixedSizeWindow';
import { AlgorithmStep, VisualizerState } from '@/src/core/engine/types';

export default function FixedSizeWindowPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.registerAlgorithm('fixed-size-window', fixedSizeWindow);
    visualizerEngine.execute('fixed-size-window', {
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    ...
                    <span className="font-code-md text-primary">{variables.windowSize ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">
                      Window Start
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    ...
                    <span className="font-code-md text-tertiary text-xs">
                      {variables.windowElements ? `[${variables.windowElements}]` : '-'}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-tertiary">fixedSizeWindow</span>(arr, k) &#123;
                    </div>
