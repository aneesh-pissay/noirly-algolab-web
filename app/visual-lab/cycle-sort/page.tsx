...
import { cycleSort } from '@/src/core/algorithms/sorting/cycleSort';
...
export default function CycleSortPage() {
  ...
  useEffect(() => {
    visualizerEngine.registerAlgorithm('cycle-sort', cycleSort);
    visualizerEngine.execute('cycle-sort', { array: [5, 2, 3, 1, 4] });
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">Cycle Start</span>
                    <span className="font-code-md text-primary">{variables.cycleStart ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">Position</span>
                    <span className="font-code-md text-secondary">{variables.pos ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">Writes</span>
                    <span className="font-code-md text-tertiary text-lg">{variables.writes ?? 0}</span>
                  </div>
                </div>
                <div className="space-y-2 pt-4 border-t border-outline-variant/10">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-on-surface font-code-md">{variables.item ?? '-'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
            ...
            <div className="glass-panel rounded-xl flex-1 flex flex-col overflow-hidden">
              <div className="flex bg-surface-dim/80 border-b border-outline-variant/20">
                <button className="px-4 py-2.5 border-b-2 border-primary bg-surface-container-high text-on-surface text-xs font-label-sm flex items-center gap-2">
                  <span className="w-3 h-3 bg-yellow-400 rounded-sm"></span>CycleSort.js
                </button>
              </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      <span className="text-primary-container">function</span> <span className="text-tertiary">cycleSort</span>(arr) &#123;
                    </div>
                    <div>&nbsp;&nbsp;<span className="text-primary-container">let</span> writes = <span className="text-tertiary">0</span>;</div>
                    <div className={currentStep.codeLine === 3 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;<span className="text-primary-container">for</span> (<span className="text-primary-container">let</span> cycleStart = <span className="text-tertiary">0</span>; cycleStart &lt; arr.length - <span className="text-tertiary">1</span>; cycleStart++) &#123;
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">let</span> item = arr[cycleStart];</div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">let</span> pos = cycleStart;</div>
                    <div className={currentStep.codeLine === 6 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-outline-variant/60">// Find position</span>
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">for</span> (<span className="text-primary-container">let</span> i = cycleStart + <span className="text-tertiary">1</span>; i &lt; arr.length; i++)</div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (arr[i] &lt; item) pos++;</div>
                    <div className={currentStep.codeLine === 9 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (pos === cycleStart) <span className="text-primary-container">continue</span>;
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">while</span> (item === arr[pos]) pos++;</div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;[item, arr[pos]] = [arr[pos], item];</div>
                    <div className={currentStep.codeLine === 12 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;writes++;
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-outline-variant/60">// Rotate rest of cycle</span></div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">while</span> (pos !== cycleStart) &#123;</div>
