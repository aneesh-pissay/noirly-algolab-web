...
export default function BubbleSortPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.execute('bubble-sort', {
      array: [5, 3, 8, 1, 9]
    });
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    ...
                    <span className="font-code-md text-tertiary">
                      {currentStep.memory?.temp !== null && currentStep.memory?.temp !== undefined
                        ? currentStep.memory.temp
                        : 'null'}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div>
                      ...
                      <span className="text-primary-container">let</span> i = <span className="text-tertiary">0</span>; i &lt; n; i++) &#123;
                    </div>
                    {/* Line 4 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">for</span> (
                      <span className="text-primary-container">let</span> j = <span className="text-tertiary">0</span>; j &lt; n - i - <span className="text-tertiary">1</span>; j++) &#123;
                    </div>
                    {/* Line 5 */}
                    <div className={currentStep.codeLine === 5 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (arr[j] &gt; arr[j + <span className="text-tertiary">1</span>]) &#123;
                    </div>
                    {/* Line 6 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">let</span> temp = arr[j];
                    </div>
                    {/* Line 7 */}
                    <div className={currentStep.codeLine === 7 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;arr[j] = arr[j + <span className="text-tertiary">1</span>];
                    </div>
                    {/* Line 8 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;arr[j + <span className="text-tertiary">1</span>] = temp;
                    </div>
                    {/* Line 9 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;
