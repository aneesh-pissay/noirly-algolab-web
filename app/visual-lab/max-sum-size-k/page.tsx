...
import { maxSumSizeK } from '@/src/core/algorithms/sliding-window/maxSumSizeK';
import { AlgorithmStep, VisualizerState } from '@/src/core/engine/types';

export default function MaxSumSizeKPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.registerAlgorithm('max-sum-size-k', maxSumSizeK);
    visualizerEngine.execute('max-sum-size-k', {
      array: [2, 1, 5, 1, 3, 2],
      k: 3
    });
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    ...
                    <span className="font-code-md text-primary">{variables.maxSum ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">
                      Added
                    </span>
                    <span className="font-code-md text-tertiary">{variables.added ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">
                      Removed
                    </span>
                    <span className="font-code-md text-tertiary">{variables.removed ?? '-'}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-tertiary">maxSumSizeK</span>(arr, k) &#123;
                    </div>
                    ...
                    <div className={currentStep.codeLine === 10 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;maxSum = Math.<span className="text-tertiary">max</span>(maxSum, windowSum);
                    </div>
