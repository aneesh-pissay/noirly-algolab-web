...
import { pancakeSort } from '@/src/core/algorithms/sorting/pancakeSort';
...
export default function PancakeSortPage() {
  ...
  useEffect(() => {
    visualizerEngine.registerAlgorithm('pancake-sort', pancakeSort);
    visualizerEngine.execute('pancake-sort', { array: [3, 2, 4, 1] });
  ...
  const flipPoint = currentStep.visualizationData?.flipPoint;
            ...
            <div className="glass-panel rounded-xl p-6 flex flex-col flex-1 relative overflow-hidden">
              <div className="flex items-center justify-between mb-8">
                <h2 className="font-headline-sm text-headline-sm flex items-center gap-2">
                  ...
                  Array Visualization {flipPoint !== undefined && <span className="text-sm text-tertiary">(Flip at: {flipPoint})</span>}
                </h2>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">Current Size</span>
                    <span className="font-code-md text-primary">{variables.currSize ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">Max Index</span>
                    <span className="font-code-md text-secondary">{variables.maxIdx ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">Flips Count</span>
                    <span className="font-code-md text-tertiary text-lg">{variables.flips ?? 0}</span>
                  </div>
                </div>
            ...
            <div className="glass-panel rounded-xl flex-1 flex flex-col overflow-hidden">
              <div className="flex bg-surface-dim/80 border-b border-outline-variant/20">
                <button className="px-4 py-2.5 border-b-2 border-primary bg-surface-container-high text-on-surface text-xs font-label-sm flex items-center gap-2">
                  <span className="w-3 h-3 bg-yellow-400 rounded-sm"></span>PancakeSort.js
                </button>
              </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      <span className="text-primary-container">function</span> <span className="text-tertiary">pancakeSort</span>(arr) &#123;
                    </div>
                    <div>&nbsp;&nbsp;<span className="text-primary-container">for</span> (<span className="text-primary-container">let</span> currSize = arr.length; currSize &gt; <span className="text-tertiary">1</span>; currSize--) &#123;</div>
                    <div className={currentStep.codeLine === 3 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-outline-variant/60">// Find max element index</span>
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">let</span> maxIdx = <span className="text-tertiary">0</span>;</div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">for</span> (<span className="text-primary-container">let</span> i = <span className="text-tertiary">1</span>; i &lt; currSize; i++)</div>
                    <div className={currentStep.codeLine === 6 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (arr[i] &gt; arr[maxIdx]) maxIdx = i;
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (maxIdx !== currSize - <span className="text-tertiary">1</span>) &#123;</div>
                    <div className={currentStep.codeLine === 8 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-outline-variant/60">// Flip to bring max to front</span>
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;flip(arr, maxIdx);</div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-outline-variant/60">// Flip to bring to end</span></div>
                    <div className={currentStep.codeLine === 11 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;flip(arr, currSize - <span className="text-tertiary">1</span>);
                    </div>
                    <div>&nbsp;&nbsp;&nbsp;&nbsp;&#125;</div>
                    <div>&nbsp;&nbsp;&#125;</div>
                    <div className={currentStep.codeLine === 14 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>&nbsp;&nbsp;<span className="text-primary-container">return</span> arr;</div>
                  </div>
                </div>
              </div>
