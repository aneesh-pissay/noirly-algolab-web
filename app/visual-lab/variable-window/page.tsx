...
import { variableWindow } from '@/src/core/algorithms/sliding-window/variableWindow';
import { AlgorithmStep, VisualizerState } from '@/src/core/engine/types';

export default function VariableWindowPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.registerAlgorithm('variable-window', variableWindow);
    visualizerEngine.execute('variable-window', {
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-tertiary">variableWindow</span>(arr, target) &#123;
                    </div>
                    <div className={currentStep.codeLine === 2 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;<span className="text-primary-container">let</span> windowStart = <span className="text-tertiary">0</span>, currentSum = <span className="text-tertiary">0</span>;
                    </div>
                    ...
                    <div className={currentStep.codeLine === 5 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">while</span> (currentSum &gt; target && windowStart &lt;= windowEnd) &#123;
                    </div>
                    ...
                    <div className={currentStep.codeLine === 9 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (currentSum === target) <span className="text-primary-container">return</span> [windowStart, windowEnd];
                    </div>
                    <div>
                      &nbsp;&nbsp;&#125;
                    </div>
                    <div className={currentStep.codeLine === 11 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;<span className="text-primary-container">return</span> [-<span className="text-tertiary">1</span>, -<span className="text-tertiary">1</span>];
                    </div>
                    <div>
                      &#125;
                    </div>
