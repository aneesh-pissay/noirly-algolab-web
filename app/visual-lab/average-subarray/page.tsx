...
import { averageSubarray } from '@/src/core/algorithms/sliding-window/averageSubarray';
import { AlgorithmStep, VisualizerState } from '@/src/core/engine/types';

export default function AverageSubarrayPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.registerAlgorithm('average-subarray', averageSubarray);
    visualizerEngine.execute('average-subarray', {
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    ...
                    <span className="font-code-md text-primary">
                      {variables.currentAverage != null ? Number(variables.currentAverage).toFixed(2) : '-'}
                    </span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">
                    ...
                    <span className="font-code-md text-tertiary">{variables.averagesCount ?? '-'}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-tertiary">averageSubarray</span>(arr, k) &#123;
                    </div>
                    ...
                    <div className={currentStep.codeLine === 3 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;<span className="text-primary-container">let</span> windowSum = <span className="text-tertiary">0</span>;
                    </div>
                    ...
                    <div className={currentStep.codeLine === 10 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result.<span className="text-tertiary">push</span>(windowSum / k);
                    </div>
