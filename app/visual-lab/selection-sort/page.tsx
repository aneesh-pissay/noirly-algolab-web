...
export default function SelectionSortPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.execute('selection-sort', {
            ...
            <div className="glass-panel rounded-xl p-6 flex flex-col flex-1 relative overflow-hidden">
              ...
              <div className="flex-1 flex items-center justify-center gap-6 relative">
                {arrayData.map((value: number, index: number) => {
                  ...
                  const showMinIdx = variables.minIdx === index;
                    ...
                    >
                      ...
                      >
                        ...
                        {showJ && (
                          <div 
                            className={`absolute -top-10 flex flex-col items-center ${
                              (showI && showJ) || (showJ && showMinIdx)
                                ? showI ? 'left-1/2 -translate-x-1/2' : 'left-1/4 -translate-x-1/2'
                                : 'left-1/2 -translate-x-1/2'
                            }`}
                          >
                        ...
                        {/* Pointer minIdx */}
                        {showMinIdx && !showI && !showJ && (
                          <div className="absolute -top-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
                            <span className="font-code-md text-tertiary text-sm font-bold mb-1">min</span>
                            <span
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10 col-span-2">
                    ...
                    <span className="font-code-md text-tertiary">{variables.minIdx ?? '-'}</span>
                  </div>
                </div>
                <div className="space-y-2 mt-4 pt-4 border-t border-outline-variant/10">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-on-surface font-code-md">{variables.swapCount ?? 0}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className={currentStep.codeLine === 1 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-tertiary">selectionSort</span>(arr) &#123;
                    </div>
                    {/* Line 2 */}
                    <div>
                    ...
                    <div className={currentStep.codeLine === 3 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      ...
                      <span className="text-primary-container">let</span> i = <span className="text-tertiary">0</span>; i &lt; n - <span className="text-tertiary">1</span>; i++) &#123;
                    </div>
                    {/* Line 4 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">let</span> minIdx = i;
                    </div>
                    {/* Line 5 */}
                    <div className={currentStep.codeLine === 5 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">for</span> (
                      <span className="text-primary-container">let</span> j = i + <span className="text-tertiary">1</span>; j &lt; n; j++) &#123;
                    </div>
                    {/* Line 6 */}
                    <div className={currentStep.codeLine === 6 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (arr[j] &lt; arr[minIdx]) &#123;
                    </div>
                    {/* Line 7 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;minIdx = j;
                    ...
                    <div className={currentStep.codeLine === 10 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (minIdx !== i) &#123;
                    </div>
                    {/* Line 11 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">let</span> temp = arr[i];
                    </div>
                    {/* Line 12 */}
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;arr[i] = arr[minIdx];
