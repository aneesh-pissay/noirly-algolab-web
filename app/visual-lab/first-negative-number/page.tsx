...
import { firstNegative } from '@/src/core/algorithms/sliding-window/firstNegative';
import { AlgorithmStep, VisualizerState } from '@/src/core/engine/types';

export default function FirstNegativeNumberPage() {
  ...
  useEffect(() => {
    ...
    visualizerEngine.registerAlgorithm('first-negative-number', firstNegative);
    visualizerEngine.execute('first-negative-number', {
                    ...
                    >
                      ...
                      >
                        <span
                          className={`font-display text-display ${
                            isHighlighted 
                              ...
                              : isNegative ? 'text-red-300/60' : 'text-on-surface'
                          }`}
                        >
                          {value}
                        </span>
                        ...
                        {showWindowEnd && (
                          ...
                          >
                            <span className="font-code-md text-tertiary text-sm font-bold mb-1">end</span>
                            <span
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    ...
                    <span className="font-code-md text-tertiary">{variables.queueSize ?? '-'}</span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">
                      Current Result
                    ...
                    <span className="font-code-md text-primary">
                      {variables.currentResult != null ? variables.currentResult : 'None'}
                    </span>
                  </div>
                  <div className="bg-surface-dim p-3 rounded-lg border border-outline-variant/10">
                    <span className="text-[10px] font-label-sm text-on-surface-variant uppercase block mb-1">
                    ...
                    <span className="font-code-md text-tertiary">{variables.resultsCount ?? '-'}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className={currentStep.codeLine === 7 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (arr[windowEnd] &lt; <span className="text-tertiary">0</span>) negatives.<span className="text-tertiary">push</span>(windowEnd);
                    </div>
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div className={currentStep.codeLine === 9 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (windowEnd &gt;= k - <span className="text-tertiary">1</span>) &#123;
                    </div>
                    <div className={currentStep.codeLine === 10 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result.<span className="text-tertiary">push</span>(negatives.length &gt; <span className="text-tertiary">0</span> ? arr[negatives[<span className="text-tertiary">0</span>]] : <span className="text-tertiary">0</span>);
                    </div>
                    <div>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div className={currentStep.codeLine === 12 ? 'bg-primary/10 -mx-4 px-4 border-l-2 border-primary' : ''}>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-primary-container">if</span> (negatives[<span className="text-tertiary">0</span>] === windowStart) negatives.<span className="text-tertiary">shift</span>();
                    </div>
