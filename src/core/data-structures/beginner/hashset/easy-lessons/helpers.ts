...
export function createHashSetAlgorithm(
  name: string,
...
export function asRecord(set: Set<number>): Record<string, true> {
  return Object.fromEntries([...set.values()].map((value) => [String(value), true]));
}
